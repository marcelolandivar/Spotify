...
import yaml
from pytify import AuthMethod

Config = namedtuple('Config', ['client_id', 'client_secret',
...
def read_config():
    ...
    try:
        ...
        print("""Error: could not file the configuration file 'config.yaml 
        ...
        auth_url: 'http://accounts.spotify.com/authorize' api_version: 'v1'
